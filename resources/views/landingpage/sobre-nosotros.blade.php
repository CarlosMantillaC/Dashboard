...
<section class="breadcrumb-section set-bg" data-setbg="frontendlandingpage/img/breadcrumb-bg.jpg">
    <div class="container">
        <div class="row">
...
<section class="about-section spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="about-pic">
                    <img src="frontendlandingpage/img/about-us.jpg" class="img-fluid" alt="Nuestro equipo">
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-sm-6 mb-4 text-center">
                <div class="ts-item set-bg" data-setbg="frontendlandingpage/img/team/carlos.jpg">
                    <div class="ts_text">
            ...
            <div class="col-lg-3 col-sm-6 mb-4 text-center">
                <div class="ts-item set-bg" data-setbg="frontendlandingpage/img/team/arturito.jpg">
                    <div class="ts_text">
                        <h4>David Aceros</h4>
                        <span>Fundador</span>
                        <div class="tt-social">
            ...
            <div class="col-lg-3 col-sm-6 mb-4 text-center">
                <div class="ts-item set-bg" data-setbg="frontendlandingpage/img/team/isaac.jpg">
                    <div class="ts_text">
                        <h4>Isaac Diaz</h4>
